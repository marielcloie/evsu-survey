	...
	<div class="row">
		<div class="col-sm-12">
			<div class="col-sm-12" align="center">
				...
				<div class="col-sm-6">
					<a class="btn btn-default btn-block bg-success" href="<?php echo base_url('admin/approve_survey/'.$survey_info->survey_id) ?>"><span class="glyphicon glyphicon-ok"></span> Approve</a>					
				</div>
				<div class="col-sm-6">					
					<a class="btn btn-default btn-block bg-warning" href="<?php echo base_url('admin/disapprove_survey/'.$survey_info->survey_id)?>" onclick="if(!confirm('Are you sure?')) return false;"><span class="glyphicon glyphicon-remove"></span> Disapprove</a>
				</div>
			</div>
			...
			<div class="col-sm-7">
				<p><?php echo $survey_info->surveyor ?><br>			
			...
			<div class="col-sm-7">
				Limited to <?php echo $survey_info->num_respondents ?> respondents only</p>				
			</div>
			<div class="clearfix"></div>
