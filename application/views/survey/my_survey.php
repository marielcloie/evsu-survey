...
<?php if (!empty($closed_survey_info)): ?>
<?php $i=1; ?>
<br><br>
<div class="container">
	<div class="col-sm-12">
		<table class="table">
			...
			<?php foreach ($closed_survey_info as $close_val): ?>
			<tr>
				<td><?php echo $i; ?></td>
				<td><?php echo base_url('users/closed_survey/') .$survey_info->survey_id ."/" .$close_val->survey_no ."/" .$survey_info->code_link?></td>
				<td><?php echo $close_val->password_desc ?></td>
				<td><?php echo $close_val->status ?></td>
			</tr>
			<?php $i++; ?>	
			<?php endforeach ?>
		</table>		
