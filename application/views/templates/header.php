            ...
            <nav class="navbar" role="navigation">
             ...
             <div class="collapse navbar-collapse" id="example-navbar-collapse" >
              <ul class="nav nav-justified">
                <li><a href="<?php echo base_url('admin') ?>"><b>HOME</b></a></li>
                <li><a href="<?php echo base_url('admin/viewadminprofile/'.$_SESSION['id_no']); ?>"><b>PROFILE</b></a></li>
                <li class="dropdown">
                   <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                   <b>ACCOUNTS</b><span class="caret"></span></a>
                   <ul class="dropdown-menu">
                     <li><a href="<?php echo base_url('admin/manageaccounts'); ?>"><b>Manage Accounts</b></a> </li>
                     <li><a href="<?php echo base_url('admin/activitylogs'); ?>"><b>Activity Logs</b></a></li>
                   </ul>
                </li>  
                <li class="dropdown">
                   <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                   <b>SURVEYS</b><span class="caret"></span></a>
                   <ul class="dropdown-menu">
                     <li><a href="<?php echo base_url('admin/notification'); ?>"><b>Survey Requests</b></a> </li>
                     <li><a href="<?php echo base_url('admin/manage_surveys'); ?>"><b>Manage Surveys</b></a></li>
                   </ul>
                </li>  
