		...
		<form action="" method="POST">
			<div class="col-sm-6">
				<div class="col-sm-12"><br>
					...
					<div class="col-sm-9">
						<select class="btn-block" name="course">
					 		<<?php foreach ($coursess as $c_info): ?>
					 			<?php if ($c_info->course_name==$result->course): ?>
					 			<option value="<?php echo $c_info->course_name ?>" selected><?php echo $c_info->course_name ?></option>
					 			<?php else: ?>
